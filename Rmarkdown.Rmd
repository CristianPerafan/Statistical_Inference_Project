...
En la diagrama de cajas es posible observar que las medias del imdb score de los géneros difieren entre si.
...
Obtenemos un $VrP = 0.8405$ como este valor no es menor al nivel de significancia del 0.05 no rechamos la hipótesis nula. Es decir la varianza entre estos grupos es la misma.

Finalmente realizamos la prueba t de studen asumiendo que las varianza son iguales:
...
Con un nivel de significancia del 5% no hay suficiente evidencia para rechazar $H_0$ por lo cual decimos que las varianzas entre la media imdb score de las películas de drama es igual a la media imdb score de las peliculas internacionales